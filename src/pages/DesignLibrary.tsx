...
export default function DesignLibrary() {
  ...
  return <div className="min-h-screen bg-background">
      <header className="sticky top-0 z-50 bg-background/80 backdrop-blur-md border-b border-concrete">
        <div className="max-w-7xl mx-auto px-4 py-4">
          ...
          <nav className="mt-4 flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
            ...
            return <button key={section.id} onClick={() => scrollToSection(section.id)} className={cn('flex items-center gap-1.5 px-3 py-1.5 rounded-full whitespace-nowrap', 'font-mono text-[10px] uppercase tracking-wider', 'bg-surface shadow-e1 text-ink/70 hover:text-primary hover:shadow-e2 transition-all')}>
      ...
      <main className="max-w-7xl mx-auto px-4 py-8 space-y-16 shadow-engraved">
