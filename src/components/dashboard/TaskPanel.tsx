    ...
    <div className="h-full flex flex-col bg-transparent">
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full h-full flex flex-col pt-[8px] pb-[3px]">
        ...
        >
          {activeTab === "issues" && (
            <div
              className="box-border max-h-full min-h-0 min-w-0 w-full max-w-[700px] overflow-x-clip overflow-y-auto overscroll-y-none px-[10px] max-sm:px-0 pt-[11px] pb-[11px] max-pane:px-2"
              style={{
