...
export function HorizontalDateStrip({
  ...
  return (
    <div className={cn("relative mb-0 flex h-[40px] w-full items-center justify-start py-0", className)}>
        ...
        {dateOptions.map((d, idx) => {
          ...
          return (
            ...
            >
              <span
                className={cn(
                  "w-[62px] h-9 px-2 pt-[10px] pb-[10px] rounded-xl transition-colors transition-opacity",
      ...
      <div
        className="absolute top-0 bottom-0 left-1/2 -translate-x-1/2 pointer-events-none z-10 rounded-xl"
        style={{
          width: CAPSULE_WIDTH,
          height: "36px",
          marginTop: "2px",
