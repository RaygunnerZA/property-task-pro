...
export function CreateTaskRow({
  ...
  return (
    <div
      ...
      className={cn(
        "flex items-center gap-0 min-h-[32px] mt-0 py-0 rounded-[8px] transition-all duration-200",
    ...
    >
      ...
      <div
        className={cn(
          "flex-shrink-0 flex items-center justify-center w-[22px] h-8 -ml-[3px] rounded-[8px] bg-background",
