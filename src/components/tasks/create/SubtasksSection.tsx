...
import { Plus, X, GripVertical, Check, FileSignature } from "lucide-react";
            ...
            <div 
              ...
              className={cn(
                ...
                expandedId === subtask.id 
                  ...
                  : "bg-muted/30 shadow-e1 border-transparent"
              )}
            >
              {/* Main Row */}
              <div className="flex items-center gap-2 p-2">
                ...
                >
                  <Check className={cn(
                    ...
                    expandedId === subtask.id ? "text-primary" : "text-muted-foreground"
                  )} />
                </Button>
                <Button
                  type="button"
