    ...
    <div className="flex items-center gap-2">
      ...
      <div className="flex items-center gap-1 shrink-0">
        ...
        {onAdd && (
          <button
            ...
            onClick={onAdd}
            className={cn(
              'h-5 w-5 rounded-card flex items-center justify-center shrink-0',
      ...
      <div className="flex items-center gap-2 flex-wrap flex-1 min-w-0">
        {items.map((item) => (
          <button
            ...
            className={cn(
              'px-2 py-0.5 rounded-card text-xs font-medium shrink-0',
      ...
      <div className="flex items-center gap-2 shrink-0">
        ...
        <button
          ...
          className={cn(
            'h-[30px] w-[30px] rounded-card flex items-center justify-center shrink-0',
            'transition-all duration-150',
            showSearch && rowIndex === 0
              ? 'bg-card shadow-[inset_2px_2px_4px_rgba(0,0,0,0.15),inset_-1px_-1px_2px_rgba(255,255,255,0.3)]'
