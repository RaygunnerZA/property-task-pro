...
export function CreateTaskModal({
  ...
  if (variant === "column") {
    ...
    return (
      <>
        <div
          className="h-auto flex flex-col bg-background rounded-xl shadow-[2px_4px_6px_0px_rgba(0,0,0,0.15),inset_1px_1px_2px_0px_rgba(255,255,255,1),inset_-1px_-1px_2px_0px_rgba(0,0,0,0.25)] border-0 relative overflow-hidden"
