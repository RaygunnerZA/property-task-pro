...
const mockHeat: Record<number, 'low' | 'medium' | 'high'> = {
  3: 'low', 5: 'medium', 8: 'high', 12: 'medium', 15: 'low', 18: 'high', 22: 'medium', 25: 'low', 28: 'high',
};
    ...
    <section className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          <div className="bg-surface rounded-xl shadow-e2 p-4 inline-block">
            {/* Header */}
            ...
            <div className="grid grid-cols-7 mb-2" style={{ gap: config.cellGap }}>
              {WEEKDAYS.map((day) => (
                <div 
                  key={day} 
                  className="text-center uppercase tracking-wider text-muted-foreground"
                  style={{
              ...
              {days.map((day, i) => {
                ...
                return (
                  ...
                  >
                    {day && (
                      <span 
                        className={cn(isToday ? 'text-accent font-bold' : 'text-ink/80')}
                        style={{
