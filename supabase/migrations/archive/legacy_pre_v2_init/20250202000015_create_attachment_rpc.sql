-- Create RPC function to insert attachment records
-- Uses SECURITY DEFINER to bypass RLS checks
-- This allows the function to insert records regardless of RLS policies
...
BEGIN
  ...
  END IF;
  RAISE NOTICE 'Function create_attachment_record created successfully';
END $$;
