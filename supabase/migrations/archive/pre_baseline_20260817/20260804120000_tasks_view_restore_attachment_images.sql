-- Restore attachment aggregation on tasks_view.images.
-- 20260801160000 narrowed images to tasks.image_url only, so uploaded
-- attachments never appeared on task cards (illustration stayed as fallback).
