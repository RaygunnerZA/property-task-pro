-- PostgreSQL evaluates both sides of AND in IF expressions; guard property_id queries
-- behind nested IF so legal-extraction compliance_rules schema does not break seed.
