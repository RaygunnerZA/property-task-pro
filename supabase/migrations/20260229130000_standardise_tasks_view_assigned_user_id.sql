-- Standardise tasks_view: remove assignee_user_id alias, use assigned_user_id only
-- PR 4: Task Assignee Field Standardisation
-- Must DROP first: PostgreSQL cannot drop columns via CREATE OR REPLACE VIEW
