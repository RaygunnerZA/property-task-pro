-- Task followers junction + tasks_view.follower_user_ids
-- @Docs/02_Identity.md §11 · @Docs/05_Task_Engine.md §5.2
--
-- Remote was missing public.task_followers (UI wrote to a table PostgREST
-- could not find → "Couldn't update followers").

-- ---------------------------------------------------------------------------
-- 1) Who may manage followers (Owner/Manager or the assignee)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- 3) Expose follower ids on tasks_view (preserve existing shape + followers)
-- ---------------------------------------------------------------------------
